...
export const verifyEmail = {
  body: joi.object().keys({ email: generalValidationFields.email.required() }).required(),
};

export const verifyForgotPasswordCode = {
  body: verifyEmail.body.append({ otp: generalValidationFields.otp.required() }).required(),
};
