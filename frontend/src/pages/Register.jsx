...
const getRegisterErrorMessage = (err) => {
  ...
  if (
    /email service authentication failed|gmail app password|badcredentials|username and password not accepted|invalid login/i.test(
      apiMessage,
    )
  ) {
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <label style={styles.label}>
            ...
            <small style={{ color: "var(--muted)", fontSize: "0.78rem" }}>
              First and last name, each capitalised
            </small>
          </label>
...
<GoogleAuthButton onSuccess={handleGoogleSignup} />
